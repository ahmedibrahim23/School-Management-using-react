...
const Sidebar = () => {
  ...
  return (
    ...
    <Link to="teachers" className="flex items-center space-x-2 hover:bg-teal-600 p-2 rounded">
    ...
    <Link to="reports" className="flex items-center space-x-2 hover:bg-teal-600 p-2 rounded">
      <FaClipboardList size={34} />
