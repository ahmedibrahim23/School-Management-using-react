...
const ClassForm = () => {
    ...
    useEffect(() => {
        ...
        axios.get("https://backend-school-cbcfe8928e29.herokuapp.com/api/teachers")
            .then(response => {
    ...
    const handleSubmit = (event) => {
        ...
        axios.post("https://backend-school-cbcfe8928e29.herokuapp.com/api/class/new", newClass)
            .then(response => {
